...
app.layout = html.Div([
    ...
    dash_table.DataTable(
        ...
        columns=[{'name': col, 'id': col} for col in dados_acoes.columns],
        data=dados_acoes.reset_index().to_dict('records'),
...
def update_graph(start_date, end_date, acoes_selecionadas):
    ...
    tabela_dados = df_selected_period.reset_index().to_dict('records')

    return retorno_diario_plot, correlacao_matrix_plot, estatisticas_tabela, tabela_dados
